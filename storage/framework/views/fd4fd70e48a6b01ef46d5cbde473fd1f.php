...
<head>
    ...
    <title>Login - <?php echo e(config('app.name', 'aspiaUCL')); ?></title>
    ...
    <div class="login-card-container">
        ...
        <div class="brand-panel">
            <div class="brand-symbol-wrap">
                <img src="<?php echo e(asset('images/aspia-icon.png')); ?>" alt="Aspia Logo" class="brand-symbol">
            </div>
        ...
        <div class="form-panel">
            <div class="form-header">
                <img src="<?php echo e(asset('images/aspia.png')); ?>" alt="Aspia" class="form-logo">
...
<?php /**PATH C:\xampp\htdocs\AspiaUCL\resources\views\auth\login.blade.php ENDPATH**/ ?>