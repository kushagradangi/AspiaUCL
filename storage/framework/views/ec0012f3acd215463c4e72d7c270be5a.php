...
<div class="domain-page">
    ...
    <div class="domain-panel">
        ...
        <div class="panel-header">
            ...
            <form
                action="<?php echo e(route('domains.index')); ?>"
                method="GET"
                class="search-form"
            >
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $domains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $domain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="<?php echo e(route('domains.show', $domain->slug)); ?>"
                            ...
                            <td>
                                ...
                                <?php echo e($domain->business_owner ?: '—'); ?>
                            ...
                            <td>
                                ...
                                <?php echo e($domain->display_order); ?>
                            ...
                            <td>
                                ...
                                <?php echo e($domain->created_at?->format('d M Y')); ?>
                                ...
                                <div class="actions">
                                    ...
                                    <button
                                        ...
                                        onclick="openEditDomainModal(
                                            ...
                                            <?php echo e($domain->id); ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->framework_id)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->domain_id)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->domain_code)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->name)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->slug)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->purpose)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->scope)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->business_owner)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->description)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->display_order)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->status)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->version)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->short_overview)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->business_objectives)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->business_risks)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->key_capabilities)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->typical_stakeholders)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->applicable_industries)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->applicable_technologies)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->keywords)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->tags)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->why_domain_matters)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->common_challenges)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->related_domains)->toHtml() ?>,

                                            <?php echo \Illuminate\Support\Js::from($domain->related_frameworks)->toHtml() ?>
                                    ...
                                    <form
                                        action="<?php echo e(route('domains.destroy', $domain)); ?>"
                                        method="POST"
        ...
        <?php if($domains->hasPages()): ?>
            ...
            <div class="pagination-area">
                ...
                <div class="custom-pagination">
                    ...
                    <?php $__currentLoopData = range(1, $domains->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(
                            ...
                            <?php if($page == $domains->currentPage()): ?>
                            ...
                            <?php else: ?>
                                ...
                                <a href="<?php echo e($domains->url($page)); ?>">
                                    <?php echo e($page); ?>
...
>
    ...
    <div class="modal-box">
        ...
        <form
            action="<?php echo e(route('domains.template.store')); ?>"
            method="POST"
        >
...
>
    ...
    <div class="modal-box">
        ...
        <form
            action="<?php echo e(route('domains.store')); ?>"
            method="POST"
        >
...
>
    ...
    <div class="modal-box">
        ...
        <form
            action="<?php echo e(route('domains.import')); ?>"
            method="POST"
...
<?php echo $__env->make('layouts.aspiaUcl', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\AspiaUCL\resources\views/aspiaUcl/domains/index.blade.php ENDPATH**/ ?>