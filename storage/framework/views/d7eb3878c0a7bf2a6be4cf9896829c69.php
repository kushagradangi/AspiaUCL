...
<aside class="sidebar">
    ...
    <nav class="menu">
        ...
        <a
            href="<?php echo e(route('dashboard')); ?>"
            class="menu-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>"
        >
        ...
        <!-- FRAMEWORKS -->
        <a
            href="<?php echo e(route('frameworks.index')); ?>"
            class="menu-link <?php echo e(request()->routeIs('frameworks.*') ? 'active' : ''); ?>"
        >
            <span class="menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- DOMAINS -->
        <a
            href="<?php echo e(route('domains.index')); ?>"
            class="menu-link <?php echo e(request()->routeIs('domains.*') ? 'active' : ''); ?>"
        >
            <span class="menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- CONTROLS -->
        <a
            href="<?php echo e(route('controls.index')); ?>"
            class="menu-link <?php echo e(request()->routeIs('controls.*') ? 'active' : ''); ?>"
        >
            <span class="menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- REQUIREMENTS -->
        <a
            href="<?php echo e(route('requirements.index')); ?>"
            class="menu-link <?php echo e(request()->routeIs('requirements.*') ? 'active' : ''); ?>"
        >
            <span class="menu-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
</html><?php /**PATH C:\xampp\htdocs\AspiaUCL\resources\views\layouts\aspiaUcl.blade.php ENDPATH**/ ?>